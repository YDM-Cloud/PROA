...
function [fmin0,gbest,ccurve,time_stamp_history,time_p_best_history]=WSO(WSO_Positions,itemax,lb,ub,fobj)
tic;
...
[whiteSharks,dim]=size(WSO_Positions);
    ...
    for i=1:whiteSharks
        ...
        if WSO_Positions(i,:)>=lb & WSO_Positions(i,:)<=ub%
            ...
            if (fitness(i)<fmin0)
                ...
                time_p_best_history=[time_p_best_history;fmin0];
            end
