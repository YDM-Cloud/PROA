...
%################################################################################################%
function[Score,Position,Convergence,time_stamp_history,time_p_best_history]=STOA(Positions,Max_iterations,Lb,Ub,objective)
tic;
...
while l<Max_iterations
    for i=1:size(Positions,1)  
        ...
        if fitness<Score 
            ...
            time_p_best_history=[time_p_best_history;fitness];
        end
